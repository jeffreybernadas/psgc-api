...
describe('Controller: Province Controller', () => {
  ...
  describe('getCitiesMunicipalities', () => {
    beforeEach(() => {
      const testName = expect.getState().currentTestName;
      const skipTestName =
        'Controller: Province Controller getCitiesMunicipalities should handle empty cities-municipalities result';

      if (testName !== skipTestName) {
        mockRequest.params = { provinceCode: '1403200000' };
    ...
    it('should return cities and municipalities of a province via province code', async () => {
      await getCitiesMunicipalities(mockRequest, mockResponse, mockNext);
      expect(mockResponse.json).toHaveBeenCalledWith({
        page: 1,
        limit: 10,
    ...
    it('should return correct cities and municipalities data via province code', async () => {
      await getCitiesMunicipalities(mockRequest, mockResponse, mockNext);
      expect(mockResponse.json).toHaveBeenCalledWith({
        page: 1,
        limit: 10,
